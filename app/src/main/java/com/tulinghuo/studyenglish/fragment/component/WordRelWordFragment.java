...
public class WordRelWordFragment extends Fragment {

    private WordVO wordVO;

    public WordRelWordFragment() {
    }

    public static WordRelWordFragment newInstance(WordVO vo) {
        WordRelWordFragment fragment = new WordRelWordFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        for (WordVO.RelWordVO relWordVO : wordVO.getRelWordList()) {
            for (WordVO.RelWordSubVO relWordSubVO : relWordVO.getWords()) {
                ...
                textViewEnglish.setText(relWordSubVO.getHwd());
                ...
                textViewChinese.setText(relWordVO.getPos() + ". " + relWordSubVO.getTran());
